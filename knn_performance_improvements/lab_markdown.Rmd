...
These calculations indicate that the model is 97% accurate and has a 3% error rate, which is reasonable.
...
###### Type I and Type II errors for variable-K
...
# TODO: create a plot of Type I and Type II errors? How to do this??
...
```{r}
plot(kknn_false_counts$K, kknn_false_counts$FalseNegatives, col="red", ylim=range(c(kknn_false_counts$FalseNegatives, false_counts$FalseNegatives)), xlab="K", ylab="False Negative Count", pch=0)
par(new=TRUE)
...
```{r}
plot(kknn_false_counts$K, 100 - (kknn_false_counts$Error * 100))
```